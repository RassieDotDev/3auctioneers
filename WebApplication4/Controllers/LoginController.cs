...
namespace WebApplication4.Controllers
{
    public class LoginController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Create([Bind(Include = "Id,user_name,user_email,user_password,isActive")] User_table user_table)
        {
            if (ModelState.IsValid)
            {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,user_name,user_email,user_password,isActive")] User_table user_table)
        {
            if (ModelState.IsValid)
            {
